...
Functions for accessing and updating the parameters of the board will be created. Apart from this, functions to add or remove particular balls will be provided.
			...
			\subsection{Physics}
			\par\noindent The basic law of physics will hold throughout the game.Physics we are going to use is as follows
			\begin{itemize}
			\item 
			...
			\begin{itemize}
			\item Connected or Not: A true value is sent to other clients to show that the client is connected. 
			\item Current data of paddle: Position of paddle is sent,  other clients adjust the position of the paddle on their board accordingly. 
			\item Collision with paddle or not
			% ADD MORE, AYUSH TODO
			\end{itemize}
				\begin{enumerate}
