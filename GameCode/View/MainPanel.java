...
// upper left x, y, width, height
	public void paintComponent(Graphics g)
	{
		...
		g.setColor(newColor);
		p = new Polygon(new int[] {10,50,10}, new int[] {10,10,50},3);
		g.fillPolygon(p);

		p1 = new Polygon(new int[] {590,550,590}, new int []{10,10,50},3);
		g.fillPolygon(p1);

		p2 = new Polygon(new int[] {10,50,10}, new int [] {590,590,550},3);
		g.fillPolygon(p2);

		p3 = new Polygon(new int[] {590,550,590}, new int [] {590,590,550},3);
		g.fillPolygon(p3);
	}
